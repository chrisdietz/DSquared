...
{
    public class MenuMixViewModel
    {
        public EmployeeDTO EmployeeInfo { get; set; }

        public List<MenuMixDTO> MenuMixDTOList { get; set; }
    ...
    public class MenuMixSearchViewModel
    {
        public MenuMixSearchDTO SearchDTO { get; set; }

        public List<MenuMixDTO> SearchResults { get; set; }
